...
public class OTP extends AppCompatEditText {
    ...
    private int mCurLineColor = getResources().getColor(R.color.material_blue);
    ...
    public OTP(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.pinViewStyle);
    }

    public OTP(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.OTP, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.OTP_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.OTP_itemCount, DEFAULT_COUNT);
        mPinItemSize = a.getDimensionPixelSize(R.styleable.OTP_itemSize,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        mPinItemHeight = mPinItemWidth = mPinItemSize;
        if (a.hasValue(R.styleable.OTP_itemHeight)) {
            mPinItemHeight = a.getDimensionPixelOffset(R.styleable.OTP_itemHeight,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        }
        if (a.hasValue(R.styleable.OTP_itemWidth)) {
            mPinItemWidth = a.getDimensionPixelOffset(R.styleable.OTP_itemWidth,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        }
        mPinItemSpacing = a.getDimensionPixelOffset(R.styleable.OTP_itemSpacing,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = a.getDimensionPixelOffset(R.styleable.OTP_itemRadius,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_radius));
        mLineWidth = a.getDimensionPixelOffset(R.styleable.OTP_borderWidth,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.OTP_borderColor);
        if (a.hasValue(R.styleable.OTP_lineWidth)) {
            mLineWidth = a.getDimensionPixelOffset(R.styleable.OTP_lineWidth,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_line_width));
        }
        if (a.hasValue(R.styleable.OTP_lineColor)) {
            mLineColor = a.getColorStateList(R.styleable.OTP_lineColor);
        }
